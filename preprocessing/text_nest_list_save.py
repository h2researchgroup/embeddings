...
quickpickle_dump(whole_text_unnested, "../../../models_storage/word_embeddings_data/cleaned_text_flat_2020_sept5.pkl")
print("Pickle file 1 saved!")
print("Saving List 2: Nested list")
quickpickle_dump(whole_text_nested, "../../../models_storage/word_embeddings_data/cleaned_text_nested_2020_sept5.pkl")
