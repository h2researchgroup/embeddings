...
colnames = ['file_name']
articles = pd.read_csv("../../../models_storage/word_embeddings_data/counts_and_subject.csv")
...
def year_change(x):
    try:
        ...
        return(int(x[:4]))
articles['year'] = articles['year'].apply(lambda x: year_change(x))
articles['year'] = articles['year'].apply(lambda x: int(x))
articles = articles[articles['year']//10 == 199] #1970s
articles['file_name'] = articles['article_id']
...
quickpickle_dump(whole_text_unnested, "../../../models_storage/word_embeddings_data/cleaned_text_flat_2020_oct17_1990.pkl")
print("Pickle file 1 saved!")
print("Saving List 2: Nested list")
quickpickle_dump(whole_text_nested, "../../../models_storage/word_embeddings_data/cleaned_text_nested_2020_oct17_1990.pkl")
