...
model_word2vec = gensim.models.KeyedVectors.load("../../../models_storage/word_embeddings_data/word2vec_phrased_filtered_300d_2020_sept5.bin") #change if model updated
...
text = pd.read_csv("../../../models_storage/word_embeddings_data/ocr_text_with_tags_10000.csv")
...
df.to_csv("../../../models_storage/word_embeddings_data/text_with_cosine_scores_wdg_2020_sept5.csv")
